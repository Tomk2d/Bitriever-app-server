package com.bitreiver.app_server.domain.economicEvent.entity;
...
public class EconomicEvent {
    ...
    @OneToOne(mappedBy = "economicEvent", cascade = CascadeType.ALL, orphanRemoval = true, fetch = FetchType.LAZY)
